    ...
    SimpleDataPPReply(parent, factory, res)
{
	...
	QUrl proxyResUrl = d.proxyResource(res);
#if 0
#endif
...
//#warning UNCOMMENT THIS BACK TO ENABLE ASSIGNINIG TAG TO THE RESOURCE
	grp.addStatement( Soprano::Statement(proxyResUrl,Soprano::Vocabulary::NAO::hasTag(),t.resourceUri()));
	grp.setRank(0.99);
