...
namespace Nepomuk  {
    ...
    class TvdbReply : public WebExtractor::SimpleDataPPReply
    {
        Q_OBJECT

    public:
        TvdbReply(TvdbDataPP* parent, const WebExtractor::DecisionFactory* factory, const Nepomuk::Resource& res, const QString& name, int season, int episode );
