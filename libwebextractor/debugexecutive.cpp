...
NW::ExecutiveReply * NW::DebugExecutive::requestDecisions(const NW::DecisionFactory * factory, const Nepomuk::Resource & res)
{
    return new DebugExecutiveReply(this, factory);
}

NW::DebugExecutiveReply::DebugExecutiveReply(DebugExecutive* parent, const DecisionFactory * factory):
