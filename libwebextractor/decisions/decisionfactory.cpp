...
Nepomuk::WebExtractor::DecisionCreator Nepomuk::WebExtractor::DecisionFactory::newDecision(const Executive * parent) const
{
...
Nepomuk::WebExtractor::DecisionList  Nepomuk::WebExtractor::DecisionFactory::newDecisionList(const Executive*) const
{
