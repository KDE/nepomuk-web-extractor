...
namespace Nepomuk
{
	...
	class DecisionCreator;
        ...
        class WEBEXTRACTOR_EXPORT SimpleExecutiveReply  : public ExecutiveReply
        {
                Q_OBJECT;
            public:
                SimpleExecutiveReply(Executive * parent, const  DecisionFactory * factory, const Nepomuk::Resource & res);
            ...
            protected Q_SLOTS:
                ...
                void realFinish();
            protected:
                SimpleExecutiveReply(Executive * parent, const DecisionFactory * factory, const Nepomuk::Resource & res , SimpleExecutiveReplyPrivate & p);
            private:
