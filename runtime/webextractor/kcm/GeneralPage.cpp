...
void GeneralPage::load()
{
    ...
    KConfigSkeletonItem * items[] = {
        ...
        m_config->decisionsModelSchemeItem()
    ...
    connect(kcfg_schemeSelector, SIGNAL(valueChanged()), this, SLOT(emitChanged()));
    ...
    /* decisions model scheme */
    this->kcfg_schemeSelector->setScheme(m_config->decisionsModelScheme());
...
void GeneralPage::save()
{
    ...
    m_config->setDecisionsModelScheme(this->kcfg_schemeSelector->scheme());
}
