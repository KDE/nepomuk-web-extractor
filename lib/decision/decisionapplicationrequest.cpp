...
void ND::DecisionApplicationRequest::reset()
{
    Q_D(DecisionApplicationRequest);
    // Clear all
...
void ND::DecisionApplicationRequest::identifyTargets(bool reset)
{
    Q_D(DecisionApplicationRequest);
...
void ND::DecisionApplicationRequest::identify(bool reset)
{
    Q_D(DecisionApplicationRequest);
...
QHash<QUrl, QUrl> ND::DecisionApplicationRequest::mappings() const
{
...
QSet<QUrl> ND::DecisionApplicationRequest::unidentified() const
{
    Q_D(const DecisionApplicationRequest);
    if(!d->mainRequest)
        return QSet<QUrl>();
...
QHash<QUrl, QUrl> ND::DecisionApplicationRequest::targetsMappings() const
{
    Q_D(const DecisionApplicationRequest);
    return d->targetResourceIdentificationHash;
}

bool ND::DecisionApplicationRequest::isTargetsIdentified() const
{
    Q_D(const DecisionApplicationRequest);
