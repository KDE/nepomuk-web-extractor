...
/*
bool ND::DecisionCreatorInternals::isFreezed() const
{
    return m_freeze;
}

void ND::DecisionCreatorInternals::setFreeze(bool val)
{
    m_freeze = val;
}
*/
...
/*
ND::PropertiesGroup ND::DecisionCreatorInternals::setCurrentGroup(const PropertiesGroup & group)
{
...
ND::PropertiesGroup ND::DecisionCreatorInternals::resetCurrentGroup()
{
    PropertiesGroup oldGroup = this->m_currentGroup;
    filterModel->setLog(0);
...
ND::PropertiesGroup ND::DecisionCreatorInternals::currentGroup() const
{
...
QUrl ND::DecisionCreatorInternals::proxyUrl(const Nepomuk::Resource & res)
{
...
void ND::DecisionCreatorInternals::updateModels(const QUrl & target)
{
...
void ND::DecisionCreatorInternals::initContextUrl()
{
    /*
    if (contextUrl.size())
	return;
    ...
    this->decisionRes = Nepomuk::Resource(contextUrl, ND::Vocabulary::NDCO::Decision(), manager);
    */
}
