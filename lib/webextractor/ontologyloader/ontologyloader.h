...
namespace Nepomuk {
	 ...
	 * \param sync If true then function will exit only after updating ontologies
	 * finished.
	 * \note Do not mix synchronious and asynchronious calls.
         */
        void updateLocalOntologies(bool sync = false);
