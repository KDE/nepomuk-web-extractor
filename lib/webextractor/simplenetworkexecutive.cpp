...
NW::SimpleNetworkExecutiveReply * NW::SimpleNetworkExecutive::newReply(const ND::DecisionFactory * factory, const Nepomuk::Resource & res)
{
    if(!m_factory)
        return 0;
...
NW::ExecutiveReply * NW::SimpleNetworkExecutive::requestDecisions(const ND::DecisionFactory * factory, const Nepomuk::Resource & res)
{
